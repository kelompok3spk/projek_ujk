    ...
    <div class="flex flex-wrap mt-6 -mx-3">
                        ...
                        <div class="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                            <div class="h-full bg-gradient-to-tl from-backgroundSecondary to-greenSecondary rounded-xl">
                                ...
                                <div class="relative flex items-center justify-center h-full">
                                    <img class="relative z-20 w-full pt-6" src="{{ asset('img/illustrations/logo2.png') }}" alt="rocket" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="relative h-full overflow-hidden bg-cover rounded-xl" style="background-image: url('{{ asset('img/t.jpg') }}')">
